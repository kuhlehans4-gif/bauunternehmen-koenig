...
const projects = [
  {
    ...
    images: [
      { src: '/images/arbeiten/klinkertreppe-nachher.webp', alt: 'Neu aufgemauerte Klinkertreppe', label: 'Nachher' },
      { src: '/images/arbeiten/klinkertreppe-vorher.webp', alt: 'Klinkertreppe vor dem Neuaufmauern', label: 'Vorher' },
    ],
  },
  {
    ...
    images: [
      { src: '/images/arbeiten/sockel-abdichtung-fertig.webp', alt: 'Fertig abgedichteter Sockelbereich', label: 'Fertig' },
  ...
  },
  {
    ...
    images: [
      ...
      { src: '/images/arbeiten/salzgrotte-licht.webp', alt: 'Beleuchtete Wandfläche in der Salzgrotte', label: 'Licht' },
      { src: '/images/arbeiten/salzgrotte-eingang.webp', alt: 'Eingangsbereich der fertiggestellten Salzgrotte', label: 'Eingang' },
      { src: '/images/arbeiten/salzgrotte-wand.webp', alt: 'Strukturierte Salzsteinwand in der Salzgrotte', label: 'Wand' },
    ],
  },
  {
    ...
    images: [
      ...
      { src: '/images/arbeiten/trockenbau-treppe-vorher.webp', alt: 'Treppenhaus vor dem Ausbau', label: 'Start' },
  ...
  },
  {
    ...
    images: [
      { src: '/images/arbeiten/terrassenbelag-nachher.webp', alt: 'Neu verlegter Terrassenbelag', label: 'Nachher' },
  ...
  },
  {
    ...
    images: [
      { src: '/images/arbeiten/fassade-horizontalabdichtung-fertig.webp', alt: 'Fertig instandgesetzter Fassadensockel', label: 'Fertig' },
